...
const homeSliderData = [
  {
    ...
    subtitle: (
      <>
        From luxury watches and chronographs to wall clocks and weather
        stations, Henning Koppels.
      </>
    ),
  },
  {
    ...
    title: (
      <>
        Clock <br /> Creative Furniture
      </>
    ),
    subtitle: (
      <>
        The Drop™ chair was designed by Arne Jacobsen in 1958 as part of his
        masterpiece, the legendary Radisson Blu Royal Hotel in Copenhagen.
      </>
    ),
  },
  {
    ...
    title: (
      <>
        Drop Chair <br /> The Black Leather Edition
      </>
    ),
    subtitle: (
      <>
